    ...
    <>
                ...
                <div className="nk-header-table-cell">
                    ...
                    <div className="container d-md-flex vertical_align" style={{alignItems: 'center'}}>
                        ...
                        <div>
                            ...
                            <h2 className="nk-sub-title">
                                A unique NFT breeding platform launching Winter 2021.
                            </h2>
        ...
        <div className="nk-box bg-dark-1">
            <div className="container">
                <div className="nk-gap-3"/>
                <p>
                    Legendary Labs is a unique NFT breeding platform, launching Winter 2021. Utilizing a
                    proprietary 3D model protocol, Legendary Labs will allow for greater genetic variation,
                    making for a more interesting breeding and collecting experience than
                    currently-available platforms. Beginning with a series of beautifully-designed
                    phoenixes, Legendary Labs aims to release new seasons of NFTs in the future, while
                    restricting breeding on prior seasons to allow for increasing value. Future additions to
                    the platform will include NFT training, an arena, accessories, and more!
                    {/* <!--- Simply hold
