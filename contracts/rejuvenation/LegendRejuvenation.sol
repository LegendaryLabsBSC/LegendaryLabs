...
contract LegendRejuvenation is IRejuvenationPool {
    ...
    function dropOffAtPool(
        ...
        r.visit.offspringCount = nft.tokenMeta(tokenId).breedingInstancesUsed; //TODO: chnage logic to fit nft rework
    ...
    //only LRejuvenation
    {
        ...
        uint256 currentOffspringCount = nft.tokenMeta(_tokenId).breedingInstancesUsed; // do for royalties ?
