...
interface AxieSpawningManager {
    function isSpawningAllowed(uint256 _genes, address _owner)
        external
        returns (bool);

    function isRebirthAllowed(uint256 _axieId, uint256 _genes)
        external
        returns (bool);
}

interface AxieRetirementManager {
    function isRetirementAllowed(uint256 _axieId, bool _rip)
        external
        returns (bool);
}
...
interface AxieGeneManager {
    function isEvolvementAllowed(uint256 _axieId, uint256 _newGenes)
        external
        returns (bool);
}
...
contract AxieDependency {
    ...
    function setRetirementManager(address _manager)
        external
        onlyWhitelistSetter
    {
    ...
    function setMarketplaceManager(address _manager)
        external
        onlyWhitelistSetter
    {
    ...
    function setByeSayer(address _byeSayer, bool _whitelisted)
        external
        onlyWhitelistSetter
    {
    ...
    function setMarketplace(address _marketplace, bool _whitelisted)
        external
        onlyWhitelistSetter
    {
    ...
    function setGeneScientist(address _geneScientist, bool _whitelisted)
        external
        onlyWhitelistSetter
    {
    ...
    AxiePausable
{
    ...
    function _isTokenOwner(address _ownerToCheck, uint256 _tokenId)
        private
        view
        returns (bool)
    {
    ...
    function _isTokenOperator(address _operatorToCheck, uint256 _tokenId)
        private
        view
        returns (bool)
    {
    ...
    function _isApproved(address _approvedToCheck, uint256 _tokenId)
        private
        view
        returns (bool)
    {
...
contract AxieERC721Metadata is AxieERC721BaseEnumerable, IERC721Metadata {
    ...
    function setTokenURIAffixes(string _prefix, string _suffix)
        external
        onlyCEO
    {
...
contract AxieCore is AxieERC721 {
    ...
    function getAxie(uint256 _axieId)
        external
        view
    ...
    function spawnAxie(uint256 _genes, address _owner)
        external
        onlySpawner
    ...
    function rebirthAxie(uint256 _axieId, uint256 _genes)
        external
        onlySpawner
        mustBeValidToken(_axieId)
    ...
    function retireAxie(uint256 _axieId, bool _rip)
        external
        onlyByeSayer
    ...
    function evolveAxie(uint256 _axieId, uint256 _newGenes)
        external
        onlyGeneScientist
        mustBeValidToken(_axieId)
    ...
    function _spawnAxie(uint256 _genes, address _owner)
        private
